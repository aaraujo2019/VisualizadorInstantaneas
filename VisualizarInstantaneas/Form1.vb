...
Public Class FrmInstantaneas
    ...
    Private Sub cargarinstantaneas()
        Try
            ...
            'Da = New SqlDataAdapter("SELECT fecha AS UltimaFecha, hora AS HoraActualizacion, ubicacion, tenor AS Tenor_ppm FROM dbo.PB_Instantaneas ORDER BY ubicacion DESC", Cn)
